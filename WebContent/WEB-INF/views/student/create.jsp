...
<html>
	...
	<body>
		<div class="container">
			<h1>Create New Student Form</h1>
			<form action="add" method="post" onsubmit="return checkInput(event);">
				<table class="table">
					<tr>
						<td>Name</td>
					...
					<tr>
						<td>Email</td>
						<td><input type="text" class="form-control" id="email" name="email" placeholder="Enter email id" /></td>
					</tr>
					...
					<tr>
						<td>Age</td>
						<td><input type="number" class="form-control" id="age" name="age" placeholder="Enter age" /></td>
					</tr>
